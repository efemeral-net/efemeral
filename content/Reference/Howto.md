...
Really into this tool by [Anton Zhiyanov](https://antonz.org/). Anything to decrease context switching and the distractions that come with it when you're really just trying to remember something like "what was that flag again?"

*Pulled March 3, 2025*
## Howto - a humble command-line assistant

[Howto](https://github.com/nalgeon/howto) helps you solve command-line tasks with AI. Describe the task, and `howto` will suggest a solution:
...
1. Get an API key from the provider and save it to the `HOWTO_AI_TOKEN` environment variable.
2. Set the `HOWTO_AI_MODEL` environment variable to the model name you want to use.
